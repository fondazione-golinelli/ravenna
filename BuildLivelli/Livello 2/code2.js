...
gdjs.Dialogo_32finaleCode.GDCappellettiObjects1= [];
gdjs.Dialogo_32finaleCode.GDCappellettiObjects2= [];
...
gdjs.copyArray(runtimeScene.getObjects("Cappelletti"), gdjs.Dialogo_32finaleCode.GDCappellettiObjects1);
...
}{for(var i = 0, len = gdjs.Dialogo_32finaleCode.GDCappellettiObjects1.length ;i < len;++i) {
    gdjs.Dialogo_32finaleCode.GDCappellettiObjects1[i].hide(false);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("Cappelletti"), gdjs.Dialogo_32finaleCode.GDCappellettiObjects1);
{for(var i = 0, len = gdjs.Dialogo_32finaleCode.GDCappellettiObjects1.length ;i < len;++i) {
    gdjs.Dialogo_32finaleCode.GDCappellettiObjects1[i].hide();
}
}}
...
gdjs.Dialogo_32finaleCode.GDCappellettiObjects1.length = 0;
gdjs.Dialogo_32finaleCode.GDCappellettiObjects2.length = 0;
